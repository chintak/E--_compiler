...
demo:	driveParse.o E--_lexer.o E--_parser.o Type.o LabelGenerator.o MemAlloc.o Instruction.o Ast.o STEClasses.o SymTabMgr.o Value.o SymTabEntry.o Error.o ParserUtil.o SymTab.o MemAlloc.o Register.h
	$(CXX) -o $@ $^ -lfl
...
LabelGenerator.o: LabelGenerator.h LabelGenerator.C
