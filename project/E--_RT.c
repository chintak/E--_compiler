...
void E_RT_exit() {
   if (regdump) {
      printf("\nDump of Registers R000 to R024:\n");
      ...
      printf("R010=%d\tR011=%d\tR012=%d\tR013=%d\tR014=%d\n",
             R010, R011, R012, R013, R014);
      printf("R015=%d\tR016=%d\tR017=%d\tR018=%d\tR019=%d\n",
             R015, R016, R017, R018, R019);
      printf("R020=%d\tR021=%d\tR022=%d\tR023=%d\tR024=%d\n",
   ...
   if (fregdump) {
      ...
      printf("F010=%f\tF011=%f\tF012=%f\tF013=%f\tF014=%f\n",
             F010, F011, F012, F013, F014);
      printf("F015=%f\tF016=%f\tF017=%f\tF018=%f\tF019=%f\n",
             F015, F016, F017, F018, F019);
      printf("F020=%f\tF021=%f\tF022=%f\tF023=%f\tF024=%f\n",
